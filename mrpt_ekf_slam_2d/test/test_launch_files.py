...
class TestLaunchFiles(unittest.TestCase):
    ...
    def test_launch_files_exist(self):
        ...
        expected_launch_files = [
            'ekf_slam_2d.launch.py',
            'ekf_slam_2d_rawlog.launch.py',
        ]
    ...
    def test_ekf_slam_2d_rawlog_launch(self):
        """Test ekf_slam_2d_rawlog.launch.py can be loaded."""
        self._test_launch_file('ekf_slam_2d_rawlog.launch.py')
    ...
    def test_config_files_exist(self):
        ...
        config_files = [
            os.path.join(pkg_dir, 'rviz', 'rviz_conf_ekf_2d.rviz'),
        ]
