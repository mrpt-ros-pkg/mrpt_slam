...
class CLoopCloserERD_MR : public CICPCriteriaERD<GRAPH_T>,
  public CEdgeRegistrationDecider_MR<GRAPH_T>
{
public:
        /**\brief Handy typedefs */
        /**\{*/
        /**\brief type of graph constraints */
  typedef CICPCriteriaERD<GRAPH_T> lc_parent_t;      /**< parent class */
